...
const Navbar = () => {
  return (
    <nav className="w-full h-[70px] md:h-[75px] bg-[#0B1221] border-b border-gray-800 flex items-center justify-between px-4 md:px-12 lg:px-20 sticky top-0 z-[1000] font-sans transition-all">
      <div className="flex items-center gap-6 md:gap-2.5 cursor-pointer group">
      ...
      <div className="flex items-center gap-3 md:gap-6">
        <button className="w-9 h-9 md:w-10 md:h-10 bg-[#1F2937] rounded-full flex items-center justify-center text-white hover:bg-gray-700 transition-colors relative">
        ...
        <button className="w-9 h-9 md:w-10 md:h-10 bg-[#374151] rounded-full flex items-center justify-center border border-gray-600 hover:border-blue-500 transition-all overflow-hidden">
