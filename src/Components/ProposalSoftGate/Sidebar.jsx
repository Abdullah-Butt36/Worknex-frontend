    ...
    <div className="flex flex-col gap-6 w-full font-sans">
      ...
      <section className="bg-[#111827]/50 border border-gray-800 rounded-[24px] p-6 md:p-8">
        ...
        <p className="text-gray-400 text-[14px]">
          Entrega estimada: <span className="text-gray-300 font-[600]">4 semanas</span>
        </p>
      </section>
      ...
      <section className="bg-[#111827]/50 border border-gray-800 rounded-[24px] p-6 md:p-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="relative shrink-0">
            <div className="w-16 h-16 bg-gray-700 rounded-full border-2 border-gray-800 overflow-hidden">
               {/* User Image Here */}
            </div>
          ...
          <div>
            <h3 className="text-white text-[18px] font-[700] leading-tight">Alejandro G.</h3>
            <p className="text-blue-500 text-[13px] font-[600]">Senior Brand Designer</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mb-6 pb-6 border-b border-gray-800/50">
          <div className="flex items-center gap-1 text-[#F59E0B]">
            ...
            <span className="text-gray-400 text-[13px] font-[700] ml-1">4.9</span>
            <span className="text-gray-500 text-[12px] font-[500]">(42 reseñas)</span>
          </div>
        </div>
        ...
        <div className="space-y-4 text-[13px]">
          <div className="flex justify-between items-center">
            <span className="text-gray-500 flex items-center gap-2"><MapPin size={14} /> Ubicación</span>
            <span className="text-gray-300 font-[600]">Buenos Aires, AR</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-500 flex items-center gap-2"><UserCheck size={14} /> Éxito de trabajo</span>
            <span className="text-gray-300 font-[600]">98%</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-500 flex items-center gap-2"><Calendar size={14} /> Miembro desde</span>
      ...
      <section className="bg-[#111827]/50 border border-gray-800 rounded-[24px] p-6 md:p-8">
        ...
        <div className="flex flex-wrap gap-2">
          {['Adobe Illustrator', 'Brand Identity', 'Logo Design', 'Typography'].map((skill) => (
            <span 
              key={skill} 
