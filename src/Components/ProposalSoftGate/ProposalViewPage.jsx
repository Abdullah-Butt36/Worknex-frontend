...
const ProposalViewPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#060B15] flex flex-col font-sans antialiased relative overflow-x-hidden">
      ...
      <main
        className={`flex-grow w-full max-w-[1300px] mx-auto px-4 md:px-8 lg:px-12 py-8 transition-all duration-500 ${isProtected ? "blur-none pointer-events-none" : ""}`}
      >
        <div className="mb-8">
          <nav className="flex items-center gap-2 text-[12px] text-gray-400 mb-4">
            <span>Inicio</span> / <span>Solicitudes</span> /{" "}
            <span>Rediseño de Identidad</span> /{" "}
            <span className="text-gray-200">Propuesta #482</span>
          </nav>

          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <h1 className="text-white text-[28px] md:text-[36px] font-[800]">
                Propuesta: Rediseño de Marca
              </h1>
              <span className="bg-[#FEF3C7]/10 text-[#F59E0B] text-[11px] font-[700] px-3 mt-2 py-1 rounded-full border border-[#F59E0B]/20">
                Pendiente
              </span>
            </div>
